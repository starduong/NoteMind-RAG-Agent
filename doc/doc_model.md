...
LLM_LONG_CONTEXT_MODEL = "gemini-2.5-flash"
...
LLM_STRUCTURED_MODEL = "gemini-2.5-flash"
...
LLM_RESEARCH_MODEL = LLM_LONG_CONTEXT_MODEL # gemini-2.5-flash (Đọc văn bản dài từ Vector DB)
...
LLM_QUIZ_GEN_MODEL = LLM_STRUCTURED_MODEL # gemini-2.5-flash (Tạo cấu trúc Quiz gốc)
...
LLM_ROADMAP_RESOURCE_MODEL = LLM_STRUCTURED_MODEL # gemini-2.5-flash (Xây dựng các nấc thang lộ trình)
